...
<body bgcolor="#F2FDFF">
  ...
  <div class="box1">
  	<img src="img/aikon.png"alt="" width="70" height="70"><font size="6"><a href="index.jsp">ホーム</a><a href="">本一覧</a><a href="">検索</a><a href="">マイページ</a></font>
  	<div class="tate">
  		<a class="linebox_a" href="../java/servlet/RegisterUser1Servlet">新規登録</a><a class="linebox_b" href="">ログイン</a>
  	</div>
  </div>
<div class="osusume">
